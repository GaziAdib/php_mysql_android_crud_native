...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://php-mysql-android-crud.000webhostapp.com/retrieve.php";
    Employee employee;
    ...
    private void deleteData(final String id) {
        StringRequest request = new StringRequest(Request.Method.POST, "https://php-mysql-android-crud.000webhostapp.com/delete.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {

                if(response.equalsIgnoreCase("Data Deleted")) {
                    Toast.makeText(MainActivity.this, "Data Deleted Properly", Toast.LENGTH_SHORT).show();
                } else {
